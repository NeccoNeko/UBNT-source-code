...
#ifndef __ALPINE_FABRIC_H__
#define __ALPINE_FABRIC_H__
...
/**
 * Get the system fabric register base address
 *
 * @returns	System fabric register base address
 */
void __iomem *al_fabric_reg_base_get(void);

#endif /* __ALPINE_FABRIC_H__ */
