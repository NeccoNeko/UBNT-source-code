#ifndef __AL_ALPINE_V2_64_UBNT_UDM_PRO_SE_H
#define __AL_ALPINE_V2_64_UBNT_UDM_PRO_SE_H
...
#define CONFIG_SYS_PROMPT              "ALPINE_UBNT_UDM_PRO_SE> "
#endif

#define CONFIG_RTL83XX_SWITCH
#ifdef CONFIG_RTL83XX_SWITCH
/*
 * UDM Pro v4 and before: SGMII
 * UDM Pro v5(10gx2): HS-SGMII
 * UDM Pro v6(10gx2, seperate serdes group): RGMII
 */
#define CONFIG_RTL83XX_RGMII
#endif
...
#endif /* __AL_ALPINE_V2_64_UBNT_UDM_PRO_SE_H */
