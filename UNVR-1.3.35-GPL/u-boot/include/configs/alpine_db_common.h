...
unsigned int al_bootstrap_uart_baud_rate_get(void);
...
/* Default baud rate */
#define CONFIG_BAUDRATE		al_bootstrap_uart_baud_rate_get()
...
#define CONFIG_AL_ROOTARGS_EMMC_DUAL_0 \
	"root=${emmcroot}2 rw rootwait rootfstype=ext4"
#define CONFIG_AL_ROOTARGS_EMMC_DUAL_1 \
	"root=${emmcroot}3 rw rootwait rootfstype=ext4"
#define CONFIG_AL_ROOTARGS_NFS	\
	"root=/dev/nfs rw nfsroot=${serverip}:${nfsrootdir},tcp,nolock rw ip=${ipaddr}:${serverip}:${gatewayip}:${netmask}:${board_name}:${nfseth}:none"
...
#define CONFIG_SYS_I2C_PCA953X_MULTI_TYPE
#define CONFIG_SYS_I2C_PCA953X_ADDR     0x20
#define CONFIG_SYS_I2C_PCA953X_WIDTH { {CONFIG_SYS_I2C_PCA953X_ADDR, 16, PCA957X_TYPE} }
...
#define CONFIG_AL_I2C_MUX_DEFAULT_ADDR	0x70
#define CONFIG_SYS_I2C_BUSES	{						\
		{0, {I2C_NULL_HOP} },						\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 0} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 1} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 2} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 3} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 4} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 5} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 6} } },	\
		{0, {{I2C_MUX_PCA9548, CONFIG_AL_I2C_MUX_DEFAULT_ADDR, 7} } },	\
	}
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"bootemmcdual="						\
		"lcd_print \"Loading OS...\";"				\
		"scsi init; scsi_get_disk_count;"				\
		"if test $? -eq 0; then setenv emmcroot /dev/sda; else setenv emmcroot /dev/sdb; fi;"	\
		"usb start;"						\
		"ext4load usb 0 $loadaddr_payload select-image-1;"	\
		"if test $? -eq 0; then run bootargsemmcdual1; ext4load usb 0 $loadaddr_payload uImage.1; else run bootargsemmcdual0; ext4load usb 0 $loadaddr_payload uImage.0; fi;"	\
		"bootm $loadaddr_payload - $fdtaddr;"			\
		"lcd_print Failed!\0"					\
	"emmcroot=/dev/sda\0"						\
	"kernel_select_1="						\
	...
	"rootargsemmcdual0="						\
		"setenv rootargs " CONFIG_AL_ROOTARGS_EMMC_DUAL_0 "\0"	\
	"rootargsemmcdual1="						\
		"setenv rootargs " CONFIG_AL_ROOTARGS_EMMC_DUAL_1 "\0"	\
	"rootargsnfs="							\
	...
	"bootargsemmcdual0="							\
		"run rootargsemmcdual0; setenv bootargs $rootargs " CONFIG_AL_BOOTARGS_COMMON " $bootargsextra; printenv bootargs\0"	\
	"bootargsemmcdual1="							\
		"run rootargsemmcdual1; setenv bootargs $rootargs " CONFIG_AL_BOOTARGS_COMMON " $bootargsextra; printenv bootargs\0"	\
	"bootargsnfs="							\
	...
	AL_ENV_FDT_HIGH								\
	CONFIG_SATA_ENV_HFTP 					\
	CONFIG_SATA_ENV_MFTP 					\
	CONFIG_SATA_ENV_LFTP 					\
	CONFIG_SATA_ENV_LBP				\
	CONFIG_SFP_EPRBS7				\
	CONFIG_SFP_EPRBS31				\
	CONFIG_SFP_EYE_DIAG				\
...
#define CONFIG_AL_TRACE
#define CONFIG_AL_TRACE_TMP_BUFF_ADDR		0x00ff0000
#define CONFIG_AL_TRACE_TMP_BUFF_SIZE		0x00010000

#define CONFIG_SATA_ENV_HFTP 	\
	"shftp="					\
	"serdes pma_reset_grp_en $grp $lane;" 	\
	"serdes pma_reset_lane_en $grp $lane 1;" 	\
	"serdes bist_overrides $grp 1_1;" 	\
	"serdes bist_pat $grp 2;"	\
	"serdes wr $grp p4 pma 56 7 0 AA;" 	\
	"serdes wr $grp p4 pma 57 7 0 AA;"		\
	"serdes wr $grp p4 pma 58 7 0 AA;"		\
	"serdes wr $grp p4 pma 59 7 0 AA;"		\
	"serdes wr $grp p4 pma 60 7 0 AA;"		\
	"serdes wr $grp p4 pma 61 7 0 AA;"		\
	"serdes wr $grp p4 pma 62 7 0 AA;"		\
	"serdes wr $grp p4 pma 63 7 0 AA;"		\
	"serdes wr $grp p4 pma 64 7 0 AA;"		\
	"serdes wr $grp p4 pma 65 7 0 AA;"		\
	"serdes wr $grp p4 pma 80 7 0 0;"		\
	"serdes bist_tx_en $grp $lane 1;"		\
	"serdes pm_lane_set $grp $lane pd;"	\
	"serdes pm_grp_set $grp pd;"		\
	"serdes pm_lane_set $grp $lane p0;"	\
	"serdes pm_grp_set $grp p0;"		\
	"serdes pma_reset_lane_en $grp $lane 0;"	\
	"serdes pma_reset_grp_en $grp 0\0"

#define CONFIG_SATA_ENV_MFTP 	\
	"smftp="					\
	"serdes pma_reset_grp_en $grp $lane;" 	\
	"serdes pma_reset_lane_en $grp $lane 1;" 	\
	"serdes bist_overrides $grp 1_1;" 	\
	"serdes bist_pat $grp 2;"	\
	"serdes wr $grp p4 pma 56 7 0 33;" 	\
	"serdes wr $grp p4 pma 57 7 0 33;"		\
	"serdes wr $grp p4 pma 58 7 0 33;"		\
	"serdes wr $grp p4 pma 59 7 0 33;"		\
	"serdes wr $grp p4 pma 60 7 0 33;"		\
	"serdes wr $grp p4 pma 61 7 0 33;"		\
	"serdes wr $grp p4 pma 62 7 0 33;"		\
	"serdes wr $grp p4 pma 63 7 0 33;"		\
	"serdes wr $grp p4 pma 64 7 0 33;"		\
	"serdes wr $grp p4 pma 65 7 0 33;"		\
	"serdes wr $grp p4 pma 80 7 0 0;"		\
	"serdes bist_tx_en $grp $lane 1;"		\
	"serdes pm_lane_set $grp $lane pd;"	\
	"serdes pm_grp_set $grp pd;"		\
...
#define CONFIG_SATA_ENV_LFTP 	\
	"slftp="					\
	"serdes pma_reset_grp_en $grp $lane;" 	\
	"serdes pma_reset_lane_en $grp $lane 1;" 	\
	"serdes bist_overrides $grp 1_1;" 	\
	"serdes bist_pat $grp 2;"	\
	"serdes wr $grp p4 pma 56 7 0 1E;" 	\
	"serdes wr $grp p4 pma 57 7 0 38;"		\
	"serdes wr $grp p4 pma 58 7 0 71;"		\
	"serdes wr $grp p4 pma 59 7 0 E3;"		\
	"serdes wr $grp p4 pma 60 7 0 38;"		\
	"serdes wr $grp p4 pma 61 7 0 71;"		\
	"serdes wr $grp p4 pma 62 7 0 E3;"		\
	"serdes wr $grp p4 pma 63 7 0 87;"		\
	"serdes wr $grp p4 pma 64 7 0 87;"		\
	"serdes wr $grp p4 pma 65 7 0 1E;"		\
	"serdes wr $grp p4 pma 80 7 0 0;"		\
	"serdes bist_tx_en $grp $lane 1;"		\
	"serdes pm_lane_set $grp $lane pd;"	\
	"serdes pm_grp_set $grp pd;"		\
...
#define CONFIG_SATA_ENV_LBP 	\
	"slbp="					\
	"serdes pma_reset_grp_en $grp $lane;" 	\
	"serdes pma_reset_lane_en $grp $lane 1;" 	\
	"serdes bist_overrides $grp 1_1;" 	\
	"serdes bist_pat $grp 2;"	\
	"serdes wr $grp p4 pma 56 7 0 AC;" 	\
	"serdes wr $grp p4 pma 57 7 0 C2;"		\
	"serdes wr $grp p4 pma 58 7 0 F6;"		\
	"serdes wr $grp p4 pma 59 7 0 C4;"		\
	"serdes wr $grp p4 pma 60 7 0 32;"		\
	"serdes wr $grp p4 pma 61 7 0 CA;"		\
	"serdes wr $grp p4 pma 62 7 0 CB;"		\
	"serdes wr $grp p4 pma 63 7 0 2C;"		\
	"serdes wr $grp p4 pma 64 7 0 2F;"		\
	"serdes wr $grp p4 pma 65 7 0 6C;"		\
	"serdes wr $grp p4 pma 80 7 0 0;"		\
	"serdes bist_tx_en $grp $lane 1;"		\
	"serdes pm_lane_set $grp $lane pd;"	\
	"serdes pm_grp_set $grp pd;"		\
...
#define CONFIG_SFP_EPRBS7		\
	"sfpprbs7="					\
	"serdes pma_reset_grp_en  3 1;"   \
	"serdes pma_reset_lane_en 3 0 1;"   \
	"serdes pma_reset_lane_en 3 1 1;"   \
	"serdes pma_reset_lane_en 3 2 1;"   \
	"serdes pma_reset_lane_en 3 3 1;"   \
	"serdes bist_overrides 3 1_1;"   \
	"serdes bist_pat 3 0;"   \
	"serdes bist_tx_en 3 0 1;"   \
	"serdes bist_tx_en 3 1 1;"   \
	"serdes bist_tx_en 3 2 1;"   \
	"serdes bist_tx_en 3 3 1;"   \
	"serdes pm_lane_set 3 0 pd;"   \
	"serdes pm_lane_set 3 1 pd;"   \
	"serdes pm_lane_set 3 2 pd;"   \
	"serdes pm_lane_set 3 3 pd;"   \
	"serdes pm_grp_set 3 pd;"   \
	"serdes pm_lane_set 3 0 p0;"   \
	"serdes pm_lane_set 3 1 p0;"   \
	"serdes pm_lane_set 3 2 p0;"   \
	"serdes pm_lane_set 3 3 p0;"   \
	"serdes pm_grp_set 3 p0;"   \
	"serdes pma_reset_lane_en 3 0 0;"   \
	"serdes pma_reset_lane_en 3 1 0;"   \
	"serdes pma_reset_lane_en 3 2 0;"   \
	"serdes pma_reset_lane_en 3 3 0;"   \
	"serdes pma_reset_grp_en  3 0;"   \
	"serdes rx_equal 3 0;"   \
	"serdes rx_equal 3 1;"   \
	"serdes rx_equal 3 2;"   \
	"serdes rx_equal 3 3;"   \
	"serdes bist_rx_en 3 0 0;"   \
	"serdes bist_rx_en 3 1 0;"   \
	"serdes bist_rx_en 3 2 0;"   \
	"serdes bist_rx_en 3 3 0;"   \
	"serdes bist_rx_en 3 0 1;"   \
	"serdes bist_rx_en 3 1 1;"   \
	"serdes bist_rx_en 3 2 1;"   \
	"serdes bist_rx_en 3 3 1;"   \
	"serdes tx_params_set 3 0 1 25 5 0 0;"   \
	"serdes tx_params_set 3 1 1 25 5 0 0;"   \
	"serdes tx_params_set 3 2 1 25 5 0 0;"   \
	"serdes tx_params_set 3 3 1 25 5 0 0\0"


#define CONFIG_SFP_EPRBS31		\
	"sfpprbs31="					\
	"serdes pma_reset_grp_en  3 1;"   \
	"serdes pma_reset_lane_en 3 0 1;"   \
	"serdes pma_reset_lane_en 3 1 1;"   \
...
#define CONFIG_SFP_EYE_DIAG				\
	"sfpeyediag="					\
	"serdes pma_reset_grp_en  $grp 1;"	\
	"serdes pma_reset_lane_en $grp 0 1;"	\
	"serdes pma_reset_lane_en $grp 1 1;" 	\
	"serdes pma_reset_lane_en $grp 2 1;"	\
	"serdes pma_reset_lane_en $grp 3 1;"	\
	"serdes bist_overrides $grp 1_1 ;" \
	"serdes bist_pat $grp 2;" \
	"serdes bist_tx_en $grp 0 1;" \
	"serdes bist_tx_en $grp 1 1;" \
	"serdes bist_tx_en $grp 2 1;" \
	"serdes bist_tx_en $grp 3 1;" \
	"serdes pm_lane_set $grp 0 pd;" \
	"serdes pm_lane_set $grp 1 pd;" \
	"serdes pm_lane_set $grp 2 pd;" \
	"serdes pm_lane_set $grp 3 pd;" \
	"serdes pm_grp_set $grp pd;" \
	"serdes pm_lane_set $grp 0 p0;" \
	"serdes pm_lane_set $grp 1 p0;" \
	"serdes pm_lane_set $grp 2 p0;" \
	"serdes pm_lane_set $grp 3 p0;" \
	"serdes pm_grp_set $grp p0;" \
	"serdes pma_reset_lane_en $grp 0 0;" \
	"serdes pma_reset_lane_en $grp 1 0;" \
	"serdes pma_reset_lane_en $grp 2 0;" \
	"serdes pma_reset_lane_en $grp 3 0;" \
	"serdes pma_reset_grp_en  $grp 0;" \
	"serdes eye_diag $grp 2 \0"
