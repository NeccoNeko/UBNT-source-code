...
static struct {
	...
	{ AL_MUIO_MUX_IF_ETH_0_LED,		"eth_0_led" },
	{ AL_MUIO_MUX_IF_ETH_1_LED,		"eth_1_led" },
	{ AL_MUIO_MUX_IF_ETH_2_LED,		"eth_2_led" },
	{ AL_MUIO_MUX_IF_ETH_3_LED,		"eth_3_led" },
	...
	{ AL_MUIO_MUX_IF_SGPO_CLK,		"sgpo_clk" },
	{ AL_MUIO_MUX_IF_SGPO_DS_0,		"sgpo_ds_0" },
	{ AL_MUIO_MUX_IF_SGPO_DS_1,		"sgpo_ds_1" },
	{ AL_MUIO_MUX_IF_SGPO_DS_2,		"sgpo_ds_2" },
	{ AL_MUIO_MUX_IF_SGPO_DS_3,		"sgpo_ds_3" },
	{ AL_MUIO_MUX_IF_SPIM_AUX,		"spim_aux" },
	{ AL_MUIO_MUX_IF_TDM,			"tdm" },
};
...
U_BOOT_CMD(
	...
	"        sata_0_leds, sata_1_leds\n"
	"        eth_leds, eth_0_led, eth_1_led, eth_2_led, eth_3_led\n"
	"        eth_gpio\n"
